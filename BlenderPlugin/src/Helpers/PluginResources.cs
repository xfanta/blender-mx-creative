namespace Loupedeck.BlenderPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.BlenderPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.BlenderPlugin.Resources.Resource.txt`.
